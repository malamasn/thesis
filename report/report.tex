...
\newevenside
\input{./chapters/chapter9_appendix.tex}
...
\bibliography{./bibliography/chapter1.bib,./bibliography/chapter2.bib,./bibliography/chapter3.bib,./bibliography/chapter4.bib,./bibliography/chapter5.bib,./bibliography/chapter6.bib}
