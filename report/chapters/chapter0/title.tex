\begin{titlepage}
  ...
  \begin{center}
    ...
    {\fontsize{20.26pt}{1em}\selectfont Πλήρης κάλυψη γνωστού χώρου από επίγειο όχημα με χρήση στρατηγικών πλοήγησης και σημασιολογική ανάλυση του χάρτη}
    ...
    % Title
    \large Θεσσαλονίκη, Σεπτέμβριος 2019
